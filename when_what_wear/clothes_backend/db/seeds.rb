...
Outfit.create(name: "Chambray Button Down", description: "Chambray Button Down Shirt", category: "tops", image_url: "https://i.s-madewell.com/is/image/madewell/H4605_DM1969_ld?$MW_480x610$", min_temperature: 32, max_temperature: 100, is_rainy: true, user_id: 1)
...
DatePeriod.create(date: "09/10/2018 07:37:16.00 PST", weather_id: 1)
DatePeriod.create(date: "11/25/2018 09:45:34.00 PST", weather_id: 2)
DatePeriod.create(date: "12/30/2018 12:23:56.00 PST", weather_id: 3)
DatePeriod.create(date: "02/15/2019 10:38:35.00 PST", weather_id: 4)
DatePeriod.create(date: "04/28/2019 11:14:24.00 PST", weather_id: 5)
