class Controller {
  constructor() {
    ...
    document
      .querySelector(".add-outfit")
      .addEventListener("submit", this.createPostFetch.bind(this));
    document
      .querySelector(".add-outfit")
      .addEventListener("submit", this.toggleAddForm.bind(this));
    document
      .querySelector(".edit-outfit")
      .addEventListener("submit", this.editPatchFetch.bind(this));
    ...
    document
      .querySelector(".edit-outfit")
      .addEventListener("submit", this.toggleEditForm.bind(this));
  }
    ...
    fetch(`http://localhost:3000/users/1`)
      ...
      .then(userData => {
        userData.outfits.forEach(outfit => {
          let outfitObj = new Outfit(
            outfit.id,
            outfit.name,
            outfit.description,
            outfit.category,
            outfit.image_url,
            outfit.min_temperature,
            outfit.max_temperature,
            outfit.is_rainy
          );
  ...
  createPostFetch() {
    ...
    let data = {
      ...
      min_temperature: outfitMinTemp,
      max_temperature: outfitMaxTemp,
      is_rainy: outfitRainy,
      user_id: 1
    };
